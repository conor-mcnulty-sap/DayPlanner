...
const meetingroomsRoutes = require('./routes/meetingrooms');
const teambookingRoutes = require('./routes/teambooking');
...
router.use('/api/meetingrooms', meetingroomsRoutes);
router.use('/api/teambooking', teambookingRoutes);
